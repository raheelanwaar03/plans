...
class LuckyDrawController extends Controller
{
    ...
    public function participate($id)
    {
        ...
        if ($user_balance) {
            ...
            $user_balance->save();
            // Lucky draw ID
            $luckyDrawId = rand(1111111, 9999999);
            // participate
            $participant = new LuckyParticipant();
            $participant->user_id = auth()->user()->id;
            $participant->user_name = auth()->user()->name;
            $participant->lucky_draw_id = $luckyDrawId;
    ...
    public function winner()
    {
        ...
        $participant = LuckyParticipant::where('lucky_draw_id', $winner->lucky_draw_id)->latest();
        return $participant;

...
<body>
    <h1>Earn Tokens</h1>
    <p>Click on a link, stay for 20 seconds, and earn 2 tokens! You can only visit each site once every 24 hours.</p>
    <div id="links">
        <a href="https://towelinfo.com" class="link" target="_blank" data-url="https://towelinfo.com">Towel Info</a>
        <a href="https://allserieshub.com" class="link" target="_blank" data-url="https://allserieshub.com">All Series Hub</a>
        <a href="https://aerecipes.com" class="link" target="_blank" data-url="https://aerecipes.com">AE Recipes</a>
        <a href="https://servicesh.xyz" class="link" target="_blank" data-url="https://servicesh.xyz">Service SH</a>
        <a href="https://earbudsu.com" class="link" target="_blank" data-url="https://earbudsu.com">Earbuds U</a>
        <a href="https://namemean.xyz" class="link" target="_blank" data-url="https://namemean.xyz">Name Mean</a>
    </div>
...
<form action="/boost" method="POST">
    ...
    <form action="/premium" method="POST" enctype="multipart/form-data" id="premiumForm">
        ...
        <div class="wallet-address">
            <input type="text" id="walletAddress" name="walletAddress" value="0xf574c7c90a86727301D184403cfCB63ca81d4E58" readonly>
    ...
    <script>
        ...
        <section class="kyc-form">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <label for="walletAddress">Trust Wallet Address:</label>
                <div class="wallet-address">
                    <input type="text" id="walletAddress" value="0xf574c7c90a86727301D184403cfCB63ca81d4E58" readonly>
                    <button type="button" id="copyAddressButton">Copy Address</button>
                </div>
